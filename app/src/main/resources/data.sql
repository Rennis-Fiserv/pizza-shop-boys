...
INSERT into EMPLOYEE(first_name,last_name,salary,employee_role) VALUES('dhruv','thota',50000,'E');
INSERT into EMPLOYEE(first_name,last_name,salary,employee_role) VALUES('will','cooper',50000,'E');
INSERT into EMPLOYEE(first_name,last_name,salary,employee_role) VALUES('mark','rabbit',85000,'M');
...
INSERT into ORDER_DETAIL(order_detail_id, product_id, quantity, price) VALUES (1, 1, 1, 5.5);
INSERT into ORDER_DETAIL(order_detail_id, product_id, quantity, price) VALUES (1, 2, 7, 5);
INSERT into ORDER_DETAIL(order_detail_id, product_id, quantity, price) VALUES (1, 3, 5, 5.5);
INSERT into ORDER_DETAIL(order_detail_id, product_id, quantity, price) VALUES (2, 1, 1, 5.5);
INSERT into ORDER_DETAIL(order_detail_id, product_id, quantity, price) VALUES (2, 2, 7, 5);
INSERT into ORDER_DETAIL(order_detail_id, product_id, quantity, price) VALUES (3, 3, 5, 5.5);

INSERT into CUSTOMER_ORDER(id, zip, employee_fk, customer_fk, order_placed_date) VALUES (1, 1001, 1, 1, '2021-01-11 13:23:44');
