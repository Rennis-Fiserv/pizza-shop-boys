        ...
        <form className="order-detail-form" onSubmit={handleSubmit(onSubmit)}>
                ...
                <fieldset>
                    ...
                    {product.sizes.map((size)=>(
                        <label  className={selectedSize === size ? "input-option selected" : "input-option"}  key={size}>
            ...
            <div className="order-detail-form-add-to-cart"> 
                    ...
                    <label>
                    Quantity  
                    <input className="order-detail-form-quantity" type="number" {...register('quantity')} defaultValue={1} min={1} max={99} />
                    </label>
